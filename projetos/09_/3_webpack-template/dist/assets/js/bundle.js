...
`, "",{"version":3,"sources":["webpack://./src/assets/css/style.css"],"names":[],"mappings":"AAAA;IACI,yBAAyB;IACzB,eAAe;AACnB;;AAEA;IACI,sBAAsB;IACtB,UAAU;AACd;;AAEA;IACI,SAAS;IACT,UAAU;IACV,iCAAiC;IACjC,uBAAuB;IACvB,cAAc;IACd,kBAAkB;AACtB;;AAEA;IACI,gBAAgB;IAChB,iBAAiB;IACjB,6BAA6B;IAC7B,mBAAmB;IACnB,aAAa;AACjB","sourcesContent":[":root {\n    --magenta-escuro: #8b008b;\n    --neve: #fffafa;\n}\n\n* {\n    box-sizing: border-box;\n    outline: 0;\n}\n\nbody {\n    margin: 0;\n    padding: 0;\n    background: var(--magenta-escuro);\n    font-family: sans-serif;\n    font-size: 1em;\n    line-height: 1.5em;\n}\n\n.section {\n    max-width: 560px;\n    margin: 50px auto;\n    background-color: var(--neve);\n    border-radius: 20px;\n    padding: 20px;\n}\n"],"sourceRoot":""}]);
// Exports
...
/* harmony import */ var _modules_module1__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/module1 */ "./src/modules/module1.js");
